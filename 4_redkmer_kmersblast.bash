...
$BLAST -db $CWD/kmers/blast/index/blastdb_Xbin -query $kmers -out $CWD/kmers/blast/rawdata/hits_Xbin -perc_identity 100 -outfmt 6 -num_threads 2
printf "======= Running blast against autosomal bin =======\n"
$BLAST -db $CWD/kmers/blast/index/blastdb_Abin -query $kmers -out $CWD/kmers/blast/rawdata/hits_Abin -perc_identity 100 -outfmt 6 -num_threads 2
printf "======= Running blast against Y chromosome bin =======\n"
$BLAST -db $CWD/kmers/blast/index/blastdb_Ybin -query $kmers -out $CWD/kmers/blast/rawdata/hits_Ybin -perc_identity 100 -outfmt 6 -num_threads 2
