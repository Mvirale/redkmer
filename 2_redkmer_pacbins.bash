...
awk '{if($4>1.5) print $1}' $CWD/counts/merge_cq.2 > $CWD/counts/X
awk '{if($4<1.5 && $4>0.2) print $1}' $CWD/counts/merge_cq.2 > $CWD/counts/A
awk '{if($4<0.2) print $1}' $CWD/counts/merge_cq.2 > $CWD/counts/Y
