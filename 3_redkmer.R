...
setwd(this.dir)
kmer<-read.table("./testproject_XRdegen_err/kmers/kmer_counts", header=T, sep="\t")
...
plot(g1)
ggsave("./testproject_XRdegen_err/kmers/kmer_points.png")

g2<- ggplot(kmer)+geom_histogram(aes(x=CQ),binwidth = 0.05)
plot(g2)
ggsave("./testproject_XRdegen_err/kmers/kmer_histogram.png")
